                                    ...
                                    @forelse ($jadwalJanjis as $index => $g)
                                        <tr class="hover:bg-gray-50  transition-all duration-200">
                                            ...
                                            <td class="px-3 py-3 lg:px-6 lg:py-4 whitespace-nowrap">
                                                ...
                                                @elseif($g->status == 'accepted')
                                                    <span class="px-2 py-1 inline-flex flex-col items-start">
                                                        <span class="inline-flex items-center rounded-full text-xs font-medium bg-green-100 text-green-800 px-2 py-1 mb-1">
                                                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                        ...
                                                        <span class="text-xs text-green-600 ">
                                                            Silahkan menemui admin di pasar untuk penyerahan kunci pada jadwal tertera
                                                        </span>
                                                    </span>
                                                @elseif($g->status == 'rejected')
                                                    <span class="px-2 py-1 inline-flex flex-col items-start">
                                                        <span class="inline-flex items-center rounded-full text-xs font-medium bg-red-100 text-red-800 px-2 py-1 mb-1">
                                                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                        ...
                                                        <span class="text-xs text-red-600 ">
                                                            Pengajuan ditolak, silahkan ajukan ulang di menu Riwayat Sewa
                                                        </span>
                                                    </span>
                                                @endif
                                            </td>
