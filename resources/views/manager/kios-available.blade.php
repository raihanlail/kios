<x-app-layout>
    ...
    <form action="{{ route('manager.kios.available') }}" method="GET" class="flex flex-col md:flex-row gap-4 items-end">
        ...
        <div class="flex gap-2 w-full md:w-auto">
            ...
            @if($selected_pasar)
                <a href="{{ route('manager.kios.available') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-300 transition">
                    Reset
                </a>
            @endif
        </div>
                ...
                <tr>
                    <td colspan="8" class="px-6 py-4 text-center text-sm text-gray-500">
                        <div class="flex flex-col items-center justify-center py-8">
                            ...
                            @if($selected_pasar)
                                <a href="{{ route('manager.kios.available') }}" class="mt-2 text-yellow-600 hover:text-yellow-800 text-sm">
                                    Reset filter
                                </a>
                            @endif
                        </div>
