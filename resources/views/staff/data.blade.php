                        ...
                        <table class="min-w-full divide-y divide-gray-200 text-xs">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2 whitespace-nowrap text-xs">
                                        <form action="{{ route('staff.pembayaran.approve', $item) }}" method="POST" class="inline">
                                            @csrf
                                            <button type="submit" class="bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded-md mr-2 text-xs">Setujui</button>
                                        </form>
                                        <x-danger-button x-data=""
                                            x-on:click.prevent="$dispatch('open-modal', 'rejectModal{{ $item->id }}')"
